package studio.orchard.luna.SearchActivity.Adapter;
...
public class SearchActivityRecyclerViewAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public SearchActivityRecyclerViewAdapter(List<BookItemInfo> itemList, int marginTop){
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View headerView = LayoutInflater.from(parent.getContext()).inflate(R.layout.search_header, parent, false);
        if (viewType == 1) {
    ...
    private static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        private ViewHolder(View itemView) {
            super(itemView);
            bookTitle =  itemView.findViewById(R.id.search_item_title);
            bookTitleNew =  itemView.findViewById(R.id.search_item_title_new);
            bookCover =  itemView.findViewById(R.id.search_item_cover);
    ...
    private static class HeaderViewHolder extends RecyclerView.ViewHolder {
        ...
        private HeaderViewHolder(View itemView) {
            ...
            headerTitle = itemView.findViewById(R.id.search_header_title);
        }
    }
