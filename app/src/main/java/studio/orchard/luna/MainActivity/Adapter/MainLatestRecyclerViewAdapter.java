...
public class MainLatestRecyclerViewAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
    private List<BookItemInfo> itemList;
    private OnItemClickListener onItemClickListener;
    private OnItemLongClickListener onItemLongClickListener;
    private int marginTop;

    public MainLatestRecyclerViewAdapter(List<BookItemInfo> itemList, int marginTop){
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        //加载布局文件
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.main_fragment_latest_item, parent, false);
        View headerView = LayoutInflater.from(parent.getContext()).inflate(R.layout.main_fragment_latest_header, parent, false);
        if (viewType == 1) {
    ...
    private static class ViewHolder extends RecyclerView.ViewHolder {
        private TextView bookTitle, bookTitleNew;
        private ImageView bookCover;
        private ViewHolder(View itemView) {
            super(itemView);
            bookTitle =  itemView.findViewById(R.id.main_latest_title);
            bookTitleNew =  itemView.findViewById(R.id.main_latest_title_new);
            bookCover =  itemView.findViewById(R.id.main_latest_cover);
    ...
    private static class HeaderViewHolder extends RecyclerView.ViewHolder {
        ...
        private HeaderViewHolder(View itemView) {
            super(itemView);
            header = itemView.findViewById(R.id.main_latest_header);
            headerTitle = itemView.findViewById(R.id.main_latest_header_title);
        }
    }
        ...
        if(holder instanceof HeaderViewHolder){
            ...
            if(payloads.isEmpty()){
                ...
                if(position == 0){
                    ...
                    viewHolder.headerTitle.setText("最 / 近 / 更 / 新");
                }
            }
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        if(holder instanceof HeaderViewHolder){
            ...
            viewHolder.bookTitleNew.setText(item.bookTitleNew);
